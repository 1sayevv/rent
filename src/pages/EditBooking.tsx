...
export default function EditBooking() {
  const { id } = useParams();
  const { bookings, updateBooking, cars } = useData();
  ...
  useEffect(() => {
    if (booking) {
      setFormData({
        ...
        deliveryToAirport: booking.deliveryToAirport,
        deliveryToHotel: booking.deliveryToHotel,
        deliveryLocation: booking.deliveryLocation || "",
        fullInsurance: booking.fullInsurance,
        totalAmount: booking.totalAmount.toString(),
        dailyRate: booking.dailyRate.toString(),
        ownerAmount: booking.ownerAmount.toString(),
        myIncome: booking.myIncome.toString(),
  ...
  const handleSaveBooking = () => {
    ...
    updateBooking(booking.id, updatedBookingData);
